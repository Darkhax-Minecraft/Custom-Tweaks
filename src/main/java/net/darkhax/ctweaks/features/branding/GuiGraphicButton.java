...
public class GuiGraphicButton extends GuiButton {
    ...
    public GuiGraphicButton (String url, String title, int buttonID, int xPosition, int yPosition) {
        ...
        this.tooltip.add(I18n.format("site." + title + ".name"));
    ...
    public void func_146112_a (Minecraft mc, int posX, int posY) {
        ...
        super.func_146112_a(mc, posX, posY);
        ...
        if (this.isMouseOver()) {
            ...
            this.renderTooltip(posX, posY, this.tooltip);
    ...
    private void renderTooltip (int x, int y, List<String> textLines) {
        ...
        GuiUtils.drawHoveringText(textLines, x, y, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), -1, minecraft.fontRenderer);
    }
}